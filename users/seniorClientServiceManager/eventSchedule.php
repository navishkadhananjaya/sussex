...
require_once("eventOperations.php");
?>
                        ...
                        <div class="col-lg-12">
                            <div class="well">
                                <form action="" method="post" class="w-100">
                                    ...
                                    <div class="pt-2">
                                        <?php inputDropDown("<i class='fas fa-people-carry'></i>", "Event Category", "event_category", "Buns", "text"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputElement("<i class='fa fa-calendar'></i>", "Event Hosting Date", "event_hosting_date", "", "date"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputElement("<i class='fa fa-calendar'></i>", "Event End Date", "event_end_date", "", "date"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputElement("<i class='fa fa-location-arrow'></i>", "Venue", "event_venue", "", "text"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputElement("<i class='fas fa-dollar-sign'></i>", "Event Fee", "event_price", "", "text"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputElement("<i class='fa fa-users'></i>", "Number of Participants", "event_participants", "", "text"); ?>
                                    </div>
                                    <div class="pt-2">
                                        <?php inputTextArea("<i class='fa fa-comment'></i>", "Event Description", "event_description", "", 2, 24); ?>
                                    </div>
                                    <div></div>
                                </form>
                            </div>
                                                ...
                                                if ($result) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-id="<?php echo $row['Event_ID']; ?>"><?php echo $row['Event_Desc']; ?></td>
