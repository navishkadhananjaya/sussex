...
INSERT INTO `eventdetails` (`Event_ID`, `Event_Name`, `Event_Desc`, `Price`, `Event_Date`, `Event_End`, `Event_Catergory_ID`) VALUES
(1, 'Free Webinar - Web Development', 'A free webinar for the web development enthusiasts to be done by the industry experts. ', 'Free', '2020-02-20', '2020-02-20', 3),
(2, 'Project Management Crash Course', 'A course for the project management enthusiasts conducted by the industry experts.  ', '2500', '2020-02-12', '2020-02-15', 3),
(3, 'C# Crash Course', 'A full coverup of C# basics for beginners', 'Free', '2020-02-11', '2020-02-11', 3),
(4, 'Indoor Futsal Tournment', 'Sussex clubs proudly present you the 2021 Indoor Futsal Tournament\r\n\r\nAge Limit = 14+\r\n\r\nRegistration Fee - Rs.4000 Per Team\r\n\r\n7 Members Per Team', '4000', '2020-02-22', '2020-02-24', 1);
