...
function UpdateData(){
    ...
    if($eventname && $eventcategory && $eventhostingdate && $eventenddate
        && $eventvenue && $eventdescription){
        $sql = "
                    UPDATE event_details SET Event_Name='$eventname', Event_Catergory_ID = $eventcategory, Event_Date = '$eventhostingdate',
                    Venue='$eventvenue',Event_End='$eventenddate',Event_Desc='$eventdescription'
